...
<head>
    ...
    <link rel="stylesheet" href="headfootstylesssss.css">
...
document.getElementById("searchBtn").click(); 
    ...
    <?php if(isset($_SESSION['id'])){
        ...
        if($row['email']==="learnlockkpk@gmail.com" && $row['password']==="Kpk@2004")
        {?>
            <a href="admin.php">
  <img style="height:70px;width:70px;border-radius:50%;margin-top:-9px;"src="ad1.png" alt="Clickable Image" />
</a>
<?php
        }
    }
