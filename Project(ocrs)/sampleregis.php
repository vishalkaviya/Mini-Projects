...
<body>
    <div class="logdiv">
        <div class="logdivwhite">
            <h2 style="text-align:center;color:purple;">REGISTRATION</h2>
            <div class="headerlog1">
                <h3 style="margin-left:250px;margin-top:20px;"><a href="login.php"
                        style="text-decoration:none;">Login</a></h3>
                <h3 style="margin-left:70px;margin-top:20px;"><a href="regis.php"
                        style="text-decoration:none;">SignUp</a></h3>
            </div><br><br>
            <?php
     if(isset($_GET['msg'])){
...
<input autocomplete="off" class="inputs1" type="number" id="mobilenumber" name="mobilenumber"
                    ...
                    <tr>
                        <td></td>
                        <td><a href="profile.php"><input
                                style="margin-top:6px;margin-right:120px;background-color:rgb(17, 185, 40);color:white;font-size:17px;border-radius:10px;border-style:solid;border-width:3px;border-color:rgb(17, 185, 40);height:40px;width:200px;text-align:center;"
                                type="submit" name="submit" value="Sign Up"></a></td>
                    </tr><br>
                </table>

                <p class="login-link">Already have an Account in Learn Lock? <a class="log-link" href="login.php">Log
                        In</a></p>
            </form>
        </div>
    </div>
